...
export const sheetID = window.location.pathname.split('/')[2];
export const sheetType = window.location.pathname.split('/')[1];
export const projectForm = document.getElementById('project_content') as HTMLFormElement;
export const quoteForm = document.getElementById('quote-content') as HTMLFormElement;
