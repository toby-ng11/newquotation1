...
function FeatureCard({ href, title, description, index }: { href: string; title: string; description: string; index: number }) {
    return (
        <motion.a
            href={href}
            custom={index}
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-56">
                        ...
                        <DropdownMenuItem asChild>
                            <a href="/logout" className="text-destructive flex items-center gap-2 decoration-inherit">
