...
async function initItem() {
        ...
        $.ajax({
            ...
            .done((response) => {
                if (response.success && response.data) {
                    ...
                    getoum(data['item_id'], data['uom'], data['unit_price'], data['item_uid']);
                } else {
        ...
        $.ajax({
            ...
            .done(function (data) {
                ...
                $.each(data, function (i, item) {
                    let option = $('<option></option>').attr('value', item.uom).text(item.uom);
    ...
    function additem() {
        const dialogBtnAddItem = document.getElementById('item-form-btn-add') as HTMLButtonElement | null;
        disableButton(dialogBtnAddItem, true);
        let formData = $itemForm.serialize() + '&project_id=' + encodeURIComponent(projectID) + '&type=' + encodeURIComponent(sheetType);
        ...
        $.ajax({
            ...
            .fail((jqXHR, textStatus, errorThrown) => {
                console.error('Error adding item:', textStatus, errorThrown, jqXHR.responseText);
    ...
    function edititem() {
        const dialogBtnAddItem = document.getElementById('item-form-btn-add') as HTMLButtonElement | null;
        disableButton(dialogBtnAddItem, true);
        let formData = $itemForm.serialize() + '&type=' + encodeURIComponent(sheetType);
        $.ajax({
            url: '/item/edit',
            type: 'post',
            data: formData,
