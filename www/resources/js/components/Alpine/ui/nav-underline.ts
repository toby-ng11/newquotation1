export function navUnderline() {
    return {
        ...
        hoverEl: null,
        hoverClearTimeout: null, // Track the hovered tab
        init() {
        ...
        moveUnderline(el) {
            ...
            underline.style.transition = 'width 0.5s cubic-bezier(0.25, 1.5, 0.5, 1), transform 0.5s cubic-bezier(0.25, 1.5, 0.5, 1)';
