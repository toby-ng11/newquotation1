...
{
	var o=this
	return '<table id="'+this.id+'" cellspacing="0" cellpadding="0" border="0"><tbody><tr class="hideableFrame" valign="bottom" height="28">'+
	...
	'<tr><td class="hideableFrame" style="'+backImgOffset(_skin+"dialogframeleftright.gif",0,0)+'"></td><td><div id="'+o.id+'_container'+'" style="'+sty("width",o.w)+sty("height",o.h)+'">'
}
