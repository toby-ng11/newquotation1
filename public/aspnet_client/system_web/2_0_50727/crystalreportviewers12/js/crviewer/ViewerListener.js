...
bobj.crv.ViewerListener = function(viewerName, ioHandler, processingArgs) {
    ...
    else if (processingArgs) {
        this._reportProcessing = bobj.crv.newReportProcessingUI(processingArgs);
    }
