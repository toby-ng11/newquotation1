...
{
    var resultParameters = "ReportViewer.jar," + "ReportViewer_" + lang + ".jar";
        
    var subStringStartingIndex = 0;
    var langSubstring = lang;
    
    var underscoreIndex = langSubstring.indexOf("_");
    
    while (underscoreIndex != -1)
    {
        resultParameters += "," + "ReportViewer_" + lang.substring(0, subStringStartingIndex + underscoreIndex) + ".jar";
        
        subStringStartingIndex += underscoreIndex + 1;
        langSubstring = lang.substring(subStringStartingIndex, lang.length);
        
        underscoreIndex = langSubstring.indexOf("_");
    } 
